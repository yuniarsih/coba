 ...
 * @author Pramudya
 */
public class LaporanbeliFrame extends javax.swing.JFrame {

    /**
     * Creates new form LaporanjualFrame
     */
    public LaporanbeliFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabel_catatantrans.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "kode pembelian", "kode supplier", "tanggal", "total"
            }
        ));
        ...
        label_namacus.setText("Nama Supplier");
        ...
        label_namacusbulan.setText("Nama Supplier");
        ...
        jTabbedPane1.addTab("Analisis Pengeluaran", jPanel3);
    ...
    private void btn_findtglActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_findtglActionPerformed
        ...
        String[] columnNames = {"kode_pembelian", "kode_supplier", "tanggal", "total"};
        ...
        try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM pembelian WHERE tgl_pembelian LIKE '" + dateTrans + "%' ");
            
            while(rs.next()) {
                String idPenjualan = rs.getString("kode_pembelian"),
                            idPelanggan = rs.getString("kode_supplier"),
                            tglPenjualan = rs.getString("tgl_pembelian"),
                            totPenjualan = rs.getString("total_beli");
    ...
    private void showLineChart(){
        // get value how much transaction sell has done
         ...
         try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT DATE(tgl_pembelian) AS tanggal, DAY(tgl_pembelian) AS haritgl, MONTH(tgl_pembelian) AS motgl, COUNT(kode_pembelian) AS jumlah_transaksi \n" +
"FROM `pembelian` getLastRecord\n" +
"GROUP BY tanggal\n" +
"ORDER BY `kode_pembelian` DESC  LIMIT 7");
...
//        lineChartColor = new Color(204,0,51);
     ...
     private void showBarChartHasil(){
        ...
        try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT SUM(total_beli) AS harga, DATE(tgl_pembelian) AS tanggal, DAY(tgl_pembelian) AS haritgl, MONTH(tgl_pembelian) AS motgl\n" +
"FROM `pembelian` GROUP BY tanggal ORDER BY kode_pembelian DESC LIMIT 7");
        ...
        //create chart
        JFreeChart barchart;
        barchart = ChartFactory.createBarChart("jumlah pengeluaran","harian","jumlah", 
                dataset, PlotOrientation.VERTICAL, false,true,false);
    ...
    private void showLineChartIntensity(){
        ...
        try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT SUM(tr_pembelian_detail.jumlah) AS banyak_barang, DATE(pembelian.tgl_pembelian) AS tanggal, DAY(tgl_pembelian) AS haritgl, MONTH(tgl_pembelian) AS motgl\n"
                    + "FROM `pembelian` JOIN `tr_pembelian_detail`\n"
                    + "WHERE pembelian.kode_pembelian = tr_pembelian_detail.kode_pembelian\n"
                    + "GROUP BY tanggal \n"
                    + "ORDER BY pembelian.kode_pembelian DESC LIMIT 7");
...
//        lineChartColor = new Color(204,0,51);
    ...
    private void tabel_catatantransMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_catatantransMouseClicked
        ...
        DefaultTableModel tablemodel = new DefaultTableModel(columnNames, 0);
         ...
         try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM tr_pembelian_detail WHERE kode_pembelian = '" + selectedRow + "' ");
        ...
        this.tabel_detailtrans.setModel(tablemodel);
         ...
         // shot buyer to textfield buyer
          try{
            String sql = "SELECT nama FROM supplier WHERE kode_supplier = '" + selectedCust + "'";
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet r = s.executeQuery(sql);
    ...
    private void btn_findrangetglActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_findrangetglActionPerformed
        ...
        try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM pembelian WHERE tgl_pembelian BETWEEN '" + dateAwal + "' AND '" + dateAkhir + "' ");
    ...
    private void tampilDateSekarang(){
        ...
        DefaultTableModel tablemodel = new DefaultTableModel(columnNames, 0);
         ...
         try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM pembelian WHERE tgl_pembelian LIKE '" + nowDate + "%' ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String[] columnNames = {"kode pembelian", "kode supplier", "tanggal", "total"};
        DefaultTableModel tablemodel = new DefaultTableModel(columnNames, 0);
         
             try {
                 Connection c = (Connection) koneksi.configDB();
                 Statement s = c.createStatement();
                 ResultSet rs = s.executeQuery("SELECT * FROM pembelian WHERE MONTH(tgl_pembelian) = '" + itembulan + "' AND year(tgl_pembelian) = '" + itemtahun + "' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanbeliFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
