 ...
 * @author Pramudya
 */
public class adminDatauserFrame extends javax.swing.JFrame {

    /**
     * Creates new form DatauserFrame
     */
    public adminDatauserFrame() {
        initComponents();
    ...
    private void showName(){
     ...
     private void updateTable() {
        String[] columnNames = {"ID", "username", "nama", "nomor telepon", "token"};
        DefaultTableModel tablemodel = new DefaultTableModel(columnNames, 0);
        
        try {
            Connection c = (Connection) koneksi.configDB();
            Statement s = c.createStatement();
            ResultSet rs = s.executeQuery("SELECT * FROM akun");
            
            while(rs.next()) {
                String idAkun = rs.getString("kode_akun"),
                            userAkun = rs.getString("username"),
                            namaAkun = rs.getString("nama"),
                            telpAkun = rs.getString("telepon"),
                            tokenAkun = rs.getString("token");
                
                // create a single array of one rows worth of data
                String[] data = {idAkun, userAkun, namaAkun, telpAkun, tokenAkun};
    ...
    private void initComponents() {
        ...
        TabelBarang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "username", "nama", "nomor telepon", "token"
            }
        ));
        ...
        getContentPane().add(btn_hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, 80, 36));
        ...
        getContentPane().add(textFindBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 440, 430, 36));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql = ("SELECT * FROM akun WHERE nama LIKE '%" + findBarang + "%'");
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        String idSelected = this.TabelBarang.getValueAt(TabelBarang.getSelectedRow(), 0).toString();
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            try {
                String sql = "DELETE FROM akun WHERE kode_akun = '" + idSelected + "' ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminDatauserFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
